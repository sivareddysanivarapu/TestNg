...
@Parameters({ "URL","APIKey/usrname" })
	...
	@Test(dataProvider="getData")//dataprovider helper tag provides data to the test case
	...
	@Test(dependsOnMethods={"WebloginCarLoan","MobilesignoutcarLoan"})//dependsonmethods helper tag tells the testcase it runs after certain test methods
